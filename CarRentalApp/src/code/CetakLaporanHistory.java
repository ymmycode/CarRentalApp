 ...
 * @author achma
 */
public class CetakLaporanHistory extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form CetakLaporanHistory
     */
    public CetakLaporanHistory(String month, String year) {
        try {
            initComponents();
            ...
            Logger.getLogger(CetakLaporanHistory.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void Process() throws FileNotFoundException
    {
        try{
            ...
            Map prs = new HashMap();            
            InputStream filePath = this.getClass().getResourceAsStream("/report/LaporanHistoryPeminjaman.jrxml");
