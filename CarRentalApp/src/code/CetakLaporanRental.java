 ...
 * @author achma
 */
public class CetakLaporanRental extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form CetakLaporanRental
     */
    public CetakLaporanRental(String month, String year) {
        try {
            initComponents();
            ...
            Logger.getLogger(CetakLaporanRental.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void Process() throws FileNotFoundException
    {
        try{
            ...
            Map prs = new HashMap();            
            InputStream filePath = this.getClass().getResourceAsStream("/report/LaporanDataRental.jrxml");
