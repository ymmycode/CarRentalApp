...
public class CetakLaporanPembayaran extends javax.swing.JInternalFrame {
    ...
    public CetakLaporanPembayaran(String month, String year) {
        try {
            ...
            Logger.getLogger(CetakLaporanPembayaran.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void Process() throws FileNotFoundException
    {
        try{
            ...
            Map prs = new HashMap();            
            InputStream filePath = this.getClass().getResourceAsStream("/report/LaporanDataPembayaran.jrxml");
