 ...
 * @author achma
 */
public class RentalStatus extends javax.swing.JInternalFrame {
    ...
    private void CountBerjalan(){
        ...
        try {
                sql = "SELECT COUNT(*) FROM rental where rental.`status` = 'Berjalan' "; 
                rs = stat.executeQuery(sql);
    ...
    private void CountSelesai(){
        ...
        try {
                sql = "SELECT COUNT(*) FROM rental where rental.`status` = 'Selesai' "; 
                rs = stat.executeQuery(sql);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Status Rental");
        jLabel1.setToolTipText("");
        jLabel1.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        jLabel1.setIconTextGap(10);

        jScrollPane2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Sedang Berjalan", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 18))); // NOI18N
        ...
        jScrollPane3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Sudah Selesai", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 18))); // NOI18N
