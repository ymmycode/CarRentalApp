 ...
 * @author achma
 */
public class CetakLaporanMobil extends javax.swing.JInternalFrame {
    ...
    public CetakLaporanMobil() {
        try {
            ...
            Logger.getLogger(CetakLaporanMobil.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void Process() throws FileNotFoundException
    {
        try{
            ...
            Map prs = new HashMap();            
            InputStream filePath = this.getClass().getResourceAsStream("/report/LaporanMobil.jrxml");
